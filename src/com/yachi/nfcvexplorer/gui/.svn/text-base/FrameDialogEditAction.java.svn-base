 ...
 * @date 2013-07-17
 */
public class FrameDialogEditAction extends DialogFragment implements
	...
	private void addViewList() {
		for (ACTION_TYPE action : Constants.actionList) {
			View v = null;
	 ...
	 * @return
	 */
	private View inflaterValueView(String title, ACTION_TYPE type) {
		View v = inflater.inflate(view_res, null);
	...
	public void onDismiss(DialogInterface dialog) {
		if (Constants.actionList.contains(ACTION_TYPE.FUNCTION_SCREENLIGHT)) {
