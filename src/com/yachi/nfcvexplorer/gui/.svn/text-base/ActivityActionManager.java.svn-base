...
import com.yachi.nfcvexplorer.gui.framgment.DialogFragmentEditAction;
import com.yachi.nfcvexplorer.gui.framgment.DialogFragmentSelectAction;
import com.yachi.nfcvexplorer.gui.framgment.DialogFragmentEditAction.IEditActionListtener;
import com.yachi.nfcvexplorer.gui.framgment.DialogFragmentSelectAction.ISelectActionListtener;
...
/** 
 * @ClassName:	ActivityActionManager 
 * @Description:TODO(新建事件界面) 
 * @author:	xiaoyl
 * @date:	2013-7-9 下午6:28:53 
 *  
 */
public class ActivityActionManager extends BaseActivity implements
	...
	/** 事件编辑对话框 */
	DialogFragmentEditAction fragment5 ;
	/** 事件选择对话框 */
	private DialogFragmentSelectAction fragment4;
	/** 来自热门标签界面 */
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case 0:
			if (Constants.actions_in_list.size() == 0) {
				NFCUtils.toast(ActivityActionManager.this, "没有加入事件");
				return true;
			}
	...
	private void showEdit() {
		fragment5 = new DialogFragmentEditAction();
		fragment5.show(this.getSupportFragmentManager(), "");
	}

	/** 事件选择界面 */
	private void showSelect() {
		fragment4 = new DialogFragmentSelectAction();
		fragment4.show(getSupportFragmentManager(), "");
	}

	/** 标签保存界面 */
	private void startTagSave() {
		Intent intent = new Intent(this, ActivityTagSave.class);
		if (isShutCut) {
