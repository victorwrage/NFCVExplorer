 ...
 * @date 2013-08-01
 */
public class FragmentContactTag extends BaseWriteTagFragment implements LoaderManager.LoaderCallbacks<Cursor>  {
	...
	public void onClick(View arg0) {
		...
		case R.id.contact_write_lay:
			...
			Constants.write_type = ENUM_WRITE_TYPE.WRITE_CONTACT;
			...
			getActivity().finish();
			FragmentContactTag.this.startActivity(new Intent(FragmentContactTag.this.getActivity(),ActivityWriteTag.class));
			break;
	...
	public void onLoadFinished(Loader<Cursor> arg0, Cursor arg1) {
		 ...
		 /*  Constants.write_type = WRITE_TYPE.WRITE_CONTACT;
		   ...
		   Constants.write_text_array.add(arg1.getString(Contacts.DISPLAY_NAME));
			Constants.write_text_array.add(editText2.getText().toString());
*/
			startActivity(new Intent(FragmentContactTag.this.getActivity(),ActivityWriteTag.class));
			getActivity().finish();
	}
