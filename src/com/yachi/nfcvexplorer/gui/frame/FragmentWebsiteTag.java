 ...
 * @date 2013-08-01
 */
public class FragmentWebsiteTag extends SherlockFragment implements OnClickListener {
	EditText editText1;
	...
	public void onClick(View arg0) {
		...
		case R.id.website_write_lay:
			Constants.write_type = WRITE_TYPE.WRITE_WEBSITE;
			...
			getActivity().finish();
			FragmentWebsiteTag.this.startActivity(new Intent(FragmentWebsiteTag.this.getActivity(),WriteTagActivity.class));
			break;
		}
