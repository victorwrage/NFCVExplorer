 ...
 * @date 2013-08-01
 */
public class FragmentTextTag extends SherlockFragment implements OnClickListener {
	EditText editText1;
	...
	public void onClick(View arg0) {
		...
		case R.id.text_write_lay:
			Constants.write_type = WRITE_TYPE.WRITE_TEXT;
			Constants.write_text_array = new ArrayList<String>();
			Constants.write_text_array.add(editText1.getText().toString());
			getActivity().finish();
			FragmentTextTag.this.startActivity(new Intent(FragmentTextTag.this.getActivity(),WriteTagActivity.class));
			break;
		}
